 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogProperties.java#2 $$Change: 768606 $ 
...
public class InternationalizedStoreCatalogProperties extends StoreCatalogProperties
{
   ...
   * Class version
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/International/src/atg/projects/store/catalog/InternationalizedStoreCatalogProperties.java#2 $$Change: 768606 $";

  private String mDefaultSizePropertyName = "sizeDefault";
  
  /**
   * @return the default size property name
   */
  ...
  /**
   * @param pDefaultSizePropertyName the default size property name to set
   */
