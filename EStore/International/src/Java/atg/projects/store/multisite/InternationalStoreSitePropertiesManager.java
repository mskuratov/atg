 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/International/src/atg/projects/store/multisite/InternationalStoreSitePropertiesManager.java#2 $$Change: 768606 $
...
public class InternationalStoreSitePropertiesManager extends
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/International/src/atg/projects/store/multisite/InternationalStoreSitePropertiesManager.java#2 $$Change: 768606 $";
  ...
  /**
   * @param pDefaultLanguagePropertyName the String to set
   */
  ...
  /**
   * @param pLanguagesPropertyName the String to set
   */
