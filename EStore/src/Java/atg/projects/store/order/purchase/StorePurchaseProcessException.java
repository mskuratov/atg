 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/order/purchase/StorePurchaseProcessException.java#3 $$Change: 788278 $
...
public class StorePurchaseProcessException extends CommerceException {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/order/purchase/StorePurchaseProcessException.java#3 $$Change: 788278 $";
   ...
   *
   * @param pMessage the explanation of the exception.
   * @param pParams list of message parameters to correctly format the message.
   */
   ...
   * 
   * @param pMessage the explanation of the exception.
   * @param pException the initial exception which was the root cause of the problem.
   */
