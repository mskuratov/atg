 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/order/purchase/StorePurchaseProcessFormHandler.java#3 $$Change: 788278 $
...
public class StorePurchaseProcessFormHandler extends PurchaseProcessFormHandler {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/order/purchase/StorePurchaseProcessFormHandler.java#3 $$Change: 788278 $";

  /**
   * property: propertyMapName.
   */
