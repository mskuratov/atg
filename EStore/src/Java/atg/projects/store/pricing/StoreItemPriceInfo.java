 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/pricing/StoreItemPriceInfo.java#3 $$Change: 788278 $
 * @updated $DateTime: 2013/02/05 00:41:33 $$Author: jsiddaga $
 */
public class StoreItemPriceInfo extends ItemPriceInfo {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/pricing/StoreItemPriceInfo.java#3 $$Change: 788278 $";

  /**
   * property: taxPriceInfo
   */
