 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/pricing/StoreShippingPriceInfo.java#3 $$Change: 788278 $
...
public class StoreShippingPriceInfo extends ShippingPriceInfo {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/pricing/StoreShippingPriceInfo.java#3 $$Change: 788278 $";
   ...
   * 
   * @return a String representation for this StoreShippingPriceInfo.
   */
  @Override
  public String toString() {
    StringBuilder bul = new StringBuilder(super.toString());
    bul.append("; ").append("taxPriceInfo: ").append(getTaxPriceInfo());
