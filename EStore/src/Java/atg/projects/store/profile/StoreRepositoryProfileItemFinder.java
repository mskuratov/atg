 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/profile/StoreRepositoryProfileItemFinder.java#3 $$Change: 788278 $
...
public class StoreRepositoryProfileItemFinder extends RepositoryProfileItemFinder {
  ...
  "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/profile/StoreRepositoryProfileItemFinder.java#3 $$Change: 788278 $";
    ...
    throws RepositoryException
  {
    ...
    query = pQueryBuilder.createPatternMatchQuery(qe1, qe2, QueryBuilder.EQUALS, true);
    
    Query realmQuery = createRealmQuery(pQueryBuilder);

    if(realmQuery != null) {
      Query[] bothQueries = { query, realmQuery };
      Query andQuery = pQueryBuilder.createAndQuery(bothQueries);
      query = andQuery;
    }
