 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotActionConfiguration.java#2 $$Change: 768606 $ 
...
public class StoreFillRelatedItemsSlotActionConfiguration extends FillRelatedItemsSlotActionConfiguration {
   ...
   * Class version
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotActionConfiguration.java#2 $$Change: 768606 $";
  ...
  /**
   * @param pShareableTypeId the shareableTypeId to set
   */
