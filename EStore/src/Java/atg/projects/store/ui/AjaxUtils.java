 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/ui/AjaxUtils.java#2 $$Change: 768606 $
...
public class AjaxUtils {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/EStore/src/atg/projects/store/ui/AjaxUtils.java#2 $$Change: 768606 $";
  ...
  /**
   * A no args method to determine if this request is an AJAX request. The current 
   * request is obtained from the ServletUtil class.
   * 
   * @return <code>true</code> if this is an AJAX request, <code>false</code> otherwise
   */
