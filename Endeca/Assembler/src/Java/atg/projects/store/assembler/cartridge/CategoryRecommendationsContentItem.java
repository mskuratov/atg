 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/CategoryRecommendationsContentItem.java#3 $$Change: 788278 $
 * @updated $DateTime: 2013/02/05 00:41:33 $$Author: jsiddaga $
 */
public class CategoryRecommendationsContentItem extends BasicContentItem {

  //-------------------------------------------
  /** Class version string. */
  protected static final String CLASS_VERSION = 
    "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/CategoryRecommendationsContentItem.java#3 $$Change: 788278 $";
   ...
   */
  public CategoryRecommendationsContentItem(ContentItem pConfig) {
    super(pConfig);
  }
  ...
  /**
   * @return the category ID for which the recommendations should be displayed.
   */
  ...
  /**
   * @param pCategoryId - The category ID for which the recommendations should be displayed.
   */
