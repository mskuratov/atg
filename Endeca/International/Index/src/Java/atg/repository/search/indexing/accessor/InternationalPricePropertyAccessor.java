 ...
 *  
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Endeca/International/Index/src/atg/repository/search/indexing/accessor/InternationalPricePropertyAccessor.java#3 $$Change: 788278 $
...
public class InternationalPricePropertyAccessor extends PricePropertyAccessor {
  ...
  public static final String CLASS_VERSION = 
    "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/Endeca/International/Index/src/atg/repository/search/indexing/accessor/InternationalPricePropertyAccessor.java#3 $$Change: 788278 $";

  //----------------------------------------------------------------------------
  // Constants
  //----------------------------------------------------------------------------
  
  protected static final String SALE_PRICELIST_ID = "SalePriceListId";
  protected static final String LIST_PRICELIST_ID = "ListPriceListId";

  //-------------------------------------
  // property: StoreSitePropertiesManager
  //-------------------------------------
  protected InternationalStoreSitePropertiesManager mStoreSitePropertiesManager = null;
   ...
   */
  protected Map getPriceListIds(String pPropertyToParse) { 
