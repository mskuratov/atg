...
public class MobileStoreCartFormHandler extends StoreCartFormHandler {

  //-------------------------------------
  /** Class version string */

  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/10.2/Mobile/src/atg/projects/store/mobile/order/purchase/MobileStoreCartFormHandler.java#4 $$Change: 788562 $";

  
  private static final String ORIGIN_OF_ORDER = "mobile";
  ...
  public void postAddItemToOrder(DynamoHttpServletRequest pRequest,
    ...
    if (ORIGIN_OF_ORDER.equalsIgnoreCase(getOriginOfOrder())) {
      getOrder().setOriginOfOrder(ORIGIN_OF_ORDER);
    }
  }
}
