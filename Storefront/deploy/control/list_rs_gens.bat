...
echo Schema:
call %CAS_ROOT%\bin\recordstore-cmd.bat list-generations -a %RS_PREFIX%_%RS_LANG%_schema 
echo ===========
echo Dimvals:
call %CAS_ROOT%\bin\recordstore-cmd.bat list-generations -a %RS_PREFIX%_%RS_LANG%_dimvals
echo ===========
echo Precedence Rules:
call %CAS_ROOT%\bin\recordstore-cmd.bat list-generations -a %RS_PREFIX%_%RS_LANG%_prules
echo ===========
echo Data:
call %CAS_ROOT%\bin\recordstore-cmd.bat list-generations -a %RS_PREFIX%_%RS_LANG%_data
