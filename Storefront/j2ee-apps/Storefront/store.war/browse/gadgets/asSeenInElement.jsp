<%--
  ...
  Required Parameters:
    product
      The product to render details for (RepositoryItem)
    hasTemplate
      Does this product have a display template? (boolean)
    url
      The product URL   
...
<dsp:page>
  ...
  <dsp:getvalueof param="hasTemplate" var="hasTemplate"/>
    ...
    <span class="atg_store_asSeenInDescription">
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/browse/gadgets/asSeenInElement.jsp#1 $$Change: 735822 $--%>
