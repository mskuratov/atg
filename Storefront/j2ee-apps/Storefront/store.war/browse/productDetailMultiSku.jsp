<%--
  This page renders layout for products with multiple SKUs.
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/browse/productDetailMultiSku.jsp#1 $$Change: 735822 $ --%>