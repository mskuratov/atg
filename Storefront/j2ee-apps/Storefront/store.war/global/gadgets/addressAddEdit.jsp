<%--
  This Page Fragment is expecting four parameters:
      ...
      (2) checkForRequiredFields - This puts in the required flag on particular fields. Default is false.
...
<dsp:page>
  ...
  <li>
    ...
    <dsp:getvalueof var="country" bean="${formHandlerComponent}.country"/>
  ...
  <c:choose>  
    ...
    <c:choose>
      <c:when test="${empty preFillValues || preFillValues}">
        <dsp:input type="tel" bean="${formHandlerComponent}.phoneNumber" iclass="required"
  ...
  <c:if test="${allowDefaultAssignation}">
    <li class="last default">
      ...
      <dsp:getvalueof var="currentAddressId" bean="${formHandlerComponent}.addressId"/>
       <label for="atg_store_useShippingAddressAsDefault"><fmt:message key="myaccount_address.default"/></label>
        <dsp:input type="checkbox" name="useShippingAddressAsDefault" id="atg_store_useShippingAddressAsDefault"
            bean="/atg/userprofiling/ProfileFormHandler.useShippingAddressAsDefault" checked="${defaultAddressId == currentAddressId}">
          </dsp:input>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/global/gadgets/addressAddEdit.jsp#2 $$Change: 788278 $--%>
