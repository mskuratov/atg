<%--
  This gadget can be used to display an appropriate visual site indicator based 
  ...
  Optional Parameters:   
    siteId
      The site id value that will be used in preference when obtaining the site details
      for the indicator and in constructing the cross site link. If not present the site
      id associated with the product item will be used if available, otherwise the site
      id of the current site will be used.

    product
      A product repository item used together with the site id to obtain the site details
      for the indicator and in constructing the cross site link.

    path
      Used to customize the url generated via SiteLinkDroplet. Ignored if 'asLink' is false.
    ...
    absoluteResourcePath  
      ...
      For example, if 'absoluteResourcePath == true' the resource path will be of the form
        http://localhost:8080/crsdocroot/content/images/storefront/atgStore_logo_small.png
      otherwise the resource path will be of the form
        /crsdocroot/content/images/storefront/atgStore_logo_small.png
      This flag can be used, for example, in email generation where the site indicator in the email 
      message will need the full resource path.
  ...
  Example usage:
    ...
    The code excerpt below can be used to display a site indicator for the site with the specified 
    site id, backed by a customized url constructed from the appropriate context root for the site 
    and the supplied page reference and parameters. Refer to SiteLinkDroplet javadoc for more 
    information on constructing customized urls from the 'path' and 'queryParams'.
       <dsp:include page="/global/gadgets/siteIndicator.jsp">
        <dsp:param name="mode" value="icon"/>              
        <dsp:param name="siteId" value="storeSiteUS"/>
        <dsp:param name="asLink" value="true"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/global/gadgets/siteIndicator.jsp#1 $$Change: 735822 $--%>