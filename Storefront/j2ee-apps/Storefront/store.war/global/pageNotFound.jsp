...
<dsp:page>
  ...
  <%--
    ...
    Publishing servers have wrong Profile defined,that's why there will be a lot 
    of errors in the console when displaying 404 page on such servers. 
  --%>
    ...
    <dsp:oparam name="false">
      ...
      <crs:pageContainer divId="atg_store_pageNotFoundIntro" bodyClass="atg_store_pageNotFound" titleKey="">
        ...
        <div id="atg_store_contentHeader">
          <h2 class="title">
            <fmt:message key="global_pageNotFound.title"/>
          </h2>
        </div>       
        <crs:messageContainer id="atg_store_pageNotFound" messageKey="global_pageNotFound.pageNotFoundMsg"/>

        <%--
          For some reason, IE doesn't process custom error pages of small size.
          To fix this issue we need to enlarge page size. Do not remove blank divs below.
        --%>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/global/pageNotFound.jsp#1 $$Change: 735822 $--%>