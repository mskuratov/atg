<%--
  This page is used for popup pages starting together with popupEnd.jsp.
        ...
        <c:if test="${language eq 'de'}">
          ...
          <!--[if IE]>
            <link rel="stylesheet" href="${contextPath}${siteCssFile}_de_ie.css"
                  type="text/css" media="screen" title="${siteCssFile}_de_ie.css" charset="utf-8" />
          <![endif]-->
        </c:if>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/includes/popupStart.jsp#1 $$Change: 735822 $--%>
