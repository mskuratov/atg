...
//        dojo.html.hide(this.availabilityContainer);
      ...
      if (!this.data.linkItem){
         // Just replace the <a> tags with <div>'s that contain their contents.
         dojo.create("div", { innerHTML: this.imageLink.innerHTML, className: "atg_store_richCartImage"}, this.imageLink, "replace");
         dojo.create("div", { innerHTML: this.titleLink.innerHTML, className: "atg_store_richCartItemDescription" }, this.titleLink, "replace");
       }
    },
