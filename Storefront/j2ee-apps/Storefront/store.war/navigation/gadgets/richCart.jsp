    ...
    dojo.addOnLoad(function(){
      ...
      var richCartWidget=new atg.store.widget.RichCartSummary({
        ...
        onSetAllCartData: function() {
          if(window.previewHandlePageDataUpdated)
            previewHandlePageDataUpdated();
        }
      });
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/10.2/Storefront/j2ee/store.war/navigation/gadgets/richCart.jsp#2 $$Change: 788278 $--%>